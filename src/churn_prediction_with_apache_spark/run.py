...
from churn_prediction_with_apache_spark.pipeline import create_pipelines
...
class ProjectContext(KedroContext):
    ...
    project_name = "churn-prediction-with-apache-spark"
    # `project_version` is the version of kedro used to generate the project
    project_version = "0.16.2"
    package_name = "churn_prediction_with_apache_spark"
